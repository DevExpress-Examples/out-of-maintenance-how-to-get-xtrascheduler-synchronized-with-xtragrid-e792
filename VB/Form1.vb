...
Namespace SchedulerGridSync
    ...
    Public Class Form1
        ...
        Private Sub InitializeComponent()
            ...
            Me.schedulerControl1.Start = New Date(2010, 7, 11, 0, 0, 0, 0)
            ...
            Me.Text = "How to get XtraScheduler synchronized with XtraGrid"
        ...
        Private Sub schedulerDataStorage1_FilterAppointment(ByVal sender As Object, ByVal e As PersistentObjectCancelEventArgs) Handles schedulerDataStorage1.FilterAppointment
            Dim rowView As DataRowView = CType(schedulerDataStorage1.GetObjectRow(e.Object), DataRowView)
        ...
        Private Sub schedulerDataStorage1_AppointmentCollectionCleared(ByVal sender As Object, ByVal e As EventArgs) Handles schedulerDataStorage1.AppointmentCollectionCleared
            AppointmentRowHash.Clear()
        End Sub
        Private Sub schedulerDataStorage1_AppointmentCollectionAutoReloading(ByVal sender As Object, ByVal e As CancelListChangedEventArgs) Handles schedulerDataStorage1.AppointmentCollectionAutoReloading
            AppointmentRowHash.Clear()
        End Sub
        ...
        Private Sub UpdateGridSelection(ByVal apt As Appointment)
            Dim rowView As DataRowView = CType(apt.GetSourceObject(schedulerDataStorage1), DataRowView)

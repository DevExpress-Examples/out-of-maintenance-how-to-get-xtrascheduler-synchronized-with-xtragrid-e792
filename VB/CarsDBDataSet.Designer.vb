...
Namespace SchedulerGridSync
	...
	Partial Public Class CarsDBDataSet
		...
		Partial Public Class CarSchedulingDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddCarSchedulingRow(ByVal Status As Integer, ByVal Subject As String, ByVal Description As String, ByVal Label As Integer, ByVal StartTime As System.DateTime, ByVal EndTime As System.DateTime, ByVal Location As String, ByVal AllDay As Boolean) As CarSchedulingRow
				Dim rowCarSchedulingRow As CarSchedulingRow = (CType(Me.NewRow(), CarSchedulingRow))
				Dim columnValuesArray() As Object = { Status, Subject, Description, Label, StartTime, EndTime, Location, AllDay}
	...
	End Class
End Namespace
Namespace SchedulerGridSync.CarsDBDataSetTableAdapters
	...
	Partial Public Class CarSchedulingTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT Status, Subject, Description, Label, StartTime, EndTime, Location, AllDay " & "FROM CarScheduling"
